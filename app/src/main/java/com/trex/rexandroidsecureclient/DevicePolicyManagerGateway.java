...
public interface DevicePolicyManagerGateway {
     ...
     */
    @NonNull
    Map<Integer, Set<String>> getKeyPairGrants(@NonNull String alias);
     ...
     */
    @NonNull
    List<String> getDelegatedScopes(@NonNull String delegatePackage);

    /**
     * See {@link android.app.admin.DevicePolicyManager#getDelegatePackages(ComponentName, String)};
     */
    @NonNull
    List<String> getDelegatePackages(@NonNull String delegationScope);
