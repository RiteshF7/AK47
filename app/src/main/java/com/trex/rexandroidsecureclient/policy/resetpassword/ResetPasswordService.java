...
package com.trex.rexandroidsecureclient.policy.resetpassword;
...
public class ResetPasswordService extends Service {
  ...
  private static final String ACTION_RESET_PASSWORD = "com.trex.rexandroidsecureclient.RESET_PASSWORD";
