...
package com.trex.rexandroidsecureclient.policy;

import static android.os.UserManager.DISALLOW_INSTALL_UNKNOWN_SOURCES;
import static com.trex.rexandroidsecureclient.common.preference.DpcPreferenceHelper.NO_CUSTOM_CONSTRAINT;
...
import com.trex.rexandroidsecureclient.CrossProfileAppsAllowlistFragment;
import com.trex.rexandroidsecureclient.CrossProfileAppsFragment;
import com.trex.rexandroidsecureclient.DeviceAdminReceiver;
import com.trex.rexandroidsecureclient.DevicePolicyManagerGateway;
import com.trex.rexandroidsecureclient.DevicePolicyManagerGateway.FailedOperationException;
import com.trex.rexandroidsecureclient.DevicePolicyManagerGatewayImpl;
import com.trex.rexandroidsecureclient.R;
import com.trex.rexandroidsecureclient.SetupManagementActivity;
import com.trex.rexandroidsecureclient.common.AccountArrayAdapter;
import com.trex.rexandroidsecureclient.common.AppInfoArrayAdapter;
import com.trex.rexandroidsecureclient.common.BaseSearchablePolicyPreferenceFragment;
import com.trex.rexandroidsecureclient.common.CertificateUtil;
import com.trex.rexandroidsecureclient.common.Dumpable;
import com.trex.rexandroidsecureclient.common.MediaDisplayFragment;
import com.trex.rexandroidsecureclient.common.PackageInstallationUtils;
import com.trex.rexandroidsecureclient.common.ReflectionUtil;
import com.trex.rexandroidsecureclient.common.ReflectionUtil.ReflectionIsTemporaryException;
import com.trex.rexandroidsecureclient.common.UserArrayAdapter;
import com.trex.rexandroidsecureclient.common.Util;
import com.trex.rexandroidsecureclient.common.preference.CustomConstraint;
import com.trex.rexandroidsecureclient.common.preference.DpcEditTextPreference;
import com.trex.rexandroidsecureclient.common.preference.DpcPreference;
import com.trex.rexandroidsecureclient.common.preference.DpcPreferenceBase;
import com.trex.rexandroidsecureclient.common.preference.DpcPreferenceHelper;
import com.trex.rexandroidsecureclient.common.preference.DpcSwitchPreference;
import com.trex.rexandroidsecureclient.comp.BindDeviceAdminFragment;
import com.trex.rexandroidsecureclient.policy.blockuninstallation.BlockUninstallationInfoArrayAdapter;
import com.trex.rexandroidsecureclient.policy.certificate.DelegatedCertInstallerFragment;
import com.trex.rexandroidsecureclient.policy.keyguard.LockScreenPolicyFragment.Container;
import com.trex.rexandroidsecureclient.policy.keyguard.PasswordConstraintsFragment;
import com.trex.rexandroidsecureclient.policy.keymanagement.GenerateKeyAndCertificateTask;
import com.trex.rexandroidsecureclient.policy.keymanagement.KeyGenerationParameters;
import com.trex.rexandroidsecureclient.policy.keymanagement.SignAndVerifyTask;
import com.trex.rexandroidsecureclient.policy.locktask.KioskModeActivity;
import com.trex.rexandroidsecureclient.policy.locktask.LockTaskAppInfoArrayAdapter;
import com.trex.rexandroidsecureclient.policy.locktask.SetLockTaskFeaturesFragment;
import com.trex.rexandroidsecureclient.policy.networking.AlwaysOnVpnFragment;
import com.trex.rexandroidsecureclient.policy.networking.NetworkUsageStatsFragment;
import com.trex.rexandroidsecureclient.policy.networking.PrivateDnsModeFragment;
import com.trex.rexandroidsecureclient.policy.resetpassword.ResetPasswordWithTokenFragment;
import com.trex.rexandroidsecureclient.policy.systemupdatepolicy.SystemUpdatePolicyFragment;
import com.trex.rexandroidsecureclient.policy.wifimanagement.WifiConfigCreationDialog;
import com.trex.rexandroidsecureclient.policy.wifimanagement.WifiEapTlsCreateDialogFragment;
import com.trex.rexandroidsecureclient.policy.wifimanagement.WifiModificationFragment;
import com.trex.rexandroidsecureclient.profilepolicy.ProfilePolicyManagementFragment;
import com.trex.rexandroidsecureclient.profilepolicy.addsystemapps.EnableSystemAppsByIntentFragment;
import com.trex.rexandroidsecureclient.profilepolicy.apprestrictions.AppRestrictionsManagingPackageFragment;
import com.trex.rexandroidsecureclient.profilepolicy.apprestrictions.ManagedConfigurationsFragment;
import com.trex.rexandroidsecureclient.profilepolicy.delegation.DelegationFragment;
import com.trex.rexandroidsecureclient.profilepolicy.permission.ManageAppPermissionsFragment;
import com.trex.rexandroidsecureclient.transferownership.PickTransferComponentFragment;
import com.trex.rexandroidsecureclient.util.MainThreadExecutor;
...
public class PolicyManagementFragment extends BaseSearchablePolicyPreferenceFragment
  ...
  public boolean onPreferenceClick(Preference preference) {
    ...
    if (MANAGE_LOCK_TASK_LIST_KEY.equals(key)) {
      ...
      showPromptForGeneratedKeyAlias("generated-key-rexandroidsecureclient-1");
      return true;
