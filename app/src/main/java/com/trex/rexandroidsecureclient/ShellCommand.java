...
import static com.trex.rexandroidsecureclient.util.flags.Flags.command;
import static com.trex.rexandroidsecureclient.util.flags.Flags.namedParam;
import static com.trex.rexandroidsecureclient.util.flags.Flags.optional;
import static com.trex.rexandroidsecureclient.util.flags.Flags.ordinalParam;
import static com.trex.rexandroidsecureclient.util.flags.Flags.repeated;
...
import com.trex.rexandroidsecureclient.policy.SecurityLogsFragment;
import com.trex.rexandroidsecureclient.policy.resetpassword.ResetPasswordWithTokenFragment;
import com.trex.rexandroidsecureclient.util.flags.Flags;
import java.io.File;
 ...
 *
 * <p>Usage: {@code adb shell dumpsys activity service --user USER_ID com.trex.rexandroidsecureclient CMD}.
 */
        ...
        command("set-user-icon", this::setUserIcon, ordinalParam(File.class, "file"))
            .setDescription(
                "Set the user icon using the bitmap located at the given file, which must be"
                    ...
                    + " (/storage/emulated/0/Android/data/com.trex.rexandroidsecureclient/files/Pictures/UserIcons),"
                    ...
                    + " content://com.trex.rexandroidsecureclient.usericoncontentprovider/icon.png <"
                    + " /tmp/icon.png`)."));
    flags.addCommand(
        command(
